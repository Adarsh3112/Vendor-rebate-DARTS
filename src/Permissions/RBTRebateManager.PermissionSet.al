permissionset 50103 "RBT Rebate Manager"
{
    Assignable = true;
    Caption = 'RBT Rebate Manager';

    // Manager has RIMD on all domain tables (Full Agreement access) except the
    // company-wide Rebate Setup, and execute on the Rule Engine, Version Mgt., and
    // approval workflow. Posting to G/L is intentionally EXCLUDED — segregation of
    // duties requires the Rebate Poster role to invoke the Posting Engine.
