permissionset 50107 "RBT-AUDITOR"
{
    Assignable = true;
    Caption = 'RBT-AUDITOR';

    // Auditor: read-only access to every RBT table including audit and ledger
    // entries. No insert/modify/delete and no codeunit execution.
    Permissions =
